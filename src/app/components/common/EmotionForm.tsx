    ...
    <Container fluid>
      ...
      <Row>
        ...
        <Container fluid className="px-0" style={{position:"relative"}}>
          <div>
          <div style={{
            height:"2px",width:"100%",backgroundColor:"black", 
            position:"absolute",top:"0",bottom:"0",margin:"auto 0"
          }}></div>
          <div style={{
            height:"10px",width:"10px",
            position:"absolute",top:"0",bottom:"0",margin:"auto 0",
            right:"1px",WebkitTransform:"rotate(45deg)",transform:"rotate(45deg)",
            borderTop:"2px solid black",borderRight:"2px solid black"
          }}></div>
          <div style={{
            height:"10px",width:"10px",
            position:"absolute",top:"0",bottom:"0",margin:"auto 0",
            left:"1px",WebkitTransform:"rotate(45deg)",transform:"rotate(45deg)",
            borderLeft:"2px solid black",borderBottom:"2px solid black"
          }}></div>
    
          <div style={{
            height:"100%",width:"2px",backgroundColor:"black", 
            position:"absolute",left:"0",right:"0",margin:"0 auto"
          }}></div>
          <div style={{
            height:"10px",width:"10px",
            position:"absolute",left:"0",right:"0",margin:"0 auto",
            top:"1px",WebkitTransform:"rotate(45deg)",transform:"rotate(45deg)",
            borderTop:"2px solid black",borderLeft:"2px solid black"
          }}></div>
          <div style={{
            height:"10px",width:"10px",
            position:"absolute",left:"0",right:"0",margin:"0 auto",
            bottom:"1px",WebkitTransform:"rotate(45deg)",transform:"rotate(45deg)",
